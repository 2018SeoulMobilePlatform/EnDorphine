...
public class DetailsActivity extends AppCompatActivity implements DatePickerController{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setPrompt("이용기간을 선택해주세요");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK) {
            if(data != null) {
                Toast.makeText(this, "Select Data range" + data.getStringExtra(DetailsActivity.RESULT_SELECT_START_DATE) + "~" + data.getStringExtra(DetailsActivity.RESULT_SELECT_END_DATE), Toast.LENGTH_SHORT).show();
            }
        }
    }
